...
import com.testssm.o2o.enums.ProductStateEnum;
import com.testssm.o2o.service.ProductCategoryService;
import com.testssm.o2o.service.ProductService;
...
public class ProductManagementController {
    ...
    @ResponseBody
    private Map<String,Object> addProduct(HttpServletRequest request, HttpSession session){
    ...
    @ResponseBody
    private Map<String, Object> modifyProduct(HttpServletRequest request,HttpSession session) {
        Map<String, Object> modelMap = new HashMap<String, Object>();
        //是商品编辑时候调用还是上下架操作的时候调用
        //若为前者则进行验证码判断，后者则路过验证码判断
        boolean statusChange = HttpServletRequestUtil.getBoolean(request, "statusChange");
        //验证码判断
        if (!statusChange && !CodeUtil.checkVerifyCode(request,session)) {
            modelMap.put("success", false);
            modelMap.put("errMsg", "输入了错误的验证码");
            return modelMap;
        }
